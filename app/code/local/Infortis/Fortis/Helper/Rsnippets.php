...
class Infortis_Fortis_Helper_Rsnippets extends Mage_Core_Helper_Abstract
{
	...
	{
		return Mage::getStoreConfig('fortis/rsnippets/enable_product');
	}
	...
	public function getPriceProperties($product)
	{
		...
		$includeTax = Mage::getStoreConfig('fortis/rsnippets/price_incl_tax');
