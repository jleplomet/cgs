...
class Infortis_Fortis_Helper_Labels extends Mage_Core_Helper_Abstract
{	
	/**
	 * Get product labels
	 *
	...
	public function getLabels($product)
	{
		...
		$isNew = false;
		if (Mage::getStoreConfig('fortis/product_labels/new'))
		{	
			$isNew = $this->isNew($product);
		}
		
		$isSale = false;
		if (Mage::getStoreConfig('fortis/product_labels/sale'))
		{
